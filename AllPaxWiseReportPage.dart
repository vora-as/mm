...
class _AllPaxWiseReportPageState extends State<AllPaxWiseReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    _Col('Total Pax', 'totalPax'),
    _Col('Total Amount', 'totalAmount'),
  ];
  ...
  _PaxWiseRow get totalRow {
    int sumInt(String Function(_PaxWiseRow) getter) =>
    ...
    return _PaxWiseRow(
      restaurant: "Total",
      billDate: "",
      totalPax: sumInt((r) => r.totalPax).toString(),
      totalAmount: sumDouble((r) => r.totalAmount).toStringAsFixed(2),
    );
  }
  ...
  Future<void> _exportExcel() async {
    ...
    reportCell.value = "All Pax Wise Report";
    ...
    final String path = '${Directory.current.path}/AllPaxWiseReport.xlsx';
            ...
            Container(
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  // All widgets left-aligned by default inside Column/Row.
                  return Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // 1st Row: Start Date + End Date
                      Row(
                      ...
                      // 2nd Row: Restaurants dropdown + Search button (search button moved down)
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _dropdownFilter(
                          ...
                          // Move search button slightly downward
                          Padding(
                            padding: const EdgeInsets.only(top: 30.0), // adjust for more/less downward shift
...
class _PaxWiseRow {
  ...
  factory _PaxWiseRow.fromReport({required PaxWiseReport report, required String restaurant}) {
    return _PaxWiseRow(
      ...
      totalPax: report.totalPax.toString(),
