...
class _AllTimeAuditReportPageState extends State<AllTimeAuditReportPage> {
  ...
  final List<_Col> _allColumns = [
    ...
    _Col('Bill No.', 'billNo'),
    _Col('Table No.', 'tableNo'),
    _Col('KOT Time', 'kotTime'),
    _Col('Bill Date', 'billDate'),
    _Col('Bill Time', 'billTime'),
    _Col('Settle Date', 'settleDate'),
    _Col('Settle Time', 'settleTime'),
    _Col('User Created', 'userCreated'),
    _Col('User Edited', 'userEdited'),
    _Col('Remarks', 'remarks'),
    _Col('Time Diff (sec)', 'timeDifference'),
    _Col('Bill Amount', 'billAmount'),
    _Col('Settlement Mode', 'settlementMode'),
  ];
  ...
  _TimeAuditRow get totalRow {
    ...
    return _TimeAuditRow(
      ...
      billAmount: sumDouble((r) => r.billAmount).toStringAsFixed(2),
      settlementMode: "",
    );
  }
                    ...
                    itemBuilder: (context) => _allColumns.map((col) {
                      return CheckedPopupMenuItem<_Col>(
                        ...
                        child: Text(
                          col.title,
                          style: TextStyle(
                            color: col.title == 'Time Diff (sec)' ? Colors.red[700] : Colors.black,
                            fontWeight: col.title == 'Time Diff (sec)' ? FontWeight.bold : FontWeight.normal,
                          ),
                        ),
                      );
                    }).toList(),
                    ...
                    child: _loading
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children: [
                              _buildHeaderRow(headerHeight), // Sticky header
                              _buildDataRows(rowHeight), // Data
                              _buildTotalRow(rowHeight), // Sticky total
                            ],
                          ),
                        ),
                      ),
