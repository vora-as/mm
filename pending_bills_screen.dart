      ...
      if (resultData.result != null && resultData.result == true) {
        ...
        if (currentTask == "UPI QR") {
          if (billno != null && billno.isNotEmpty) {
            checkBharatQRStatusRepeatedly(context, billno);
